...
(defn clustering-coefficient
  "Computing clustering coefficient for a node in graph g as described
  in Watts, Duncan J., and Steven H. Strogatz. “Collective Dynamics of
  ‘Small-World’ Networks.” Nature 393, no. 6684 (June 1998): 440–42.
  https://doi.org/10.1038/30918."
  [g node]
  (let [neighbours (successors g node)
        potential-connections (/ (* (count neighbours) (dec (count neighbours))) 2)]
    (if (> potential-connections 1)
      ;; how many connections between the neighbours of node
      ;; are there?
